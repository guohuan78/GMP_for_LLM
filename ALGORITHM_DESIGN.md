...
```json
{
  "tests": [
    {
      "name": "基础测试1 - 简单顺序",
      "description": "两个请求顺序执行，需要offload",
      "input": "200 100 2\n0 100 0 30\n100 100 50 10",
      "expected_fin": 12040
    },
    {
      "name": "压力测试1 - 多个同时请求",
      "description": "5个请求同时开始，测试组级别处理",
      "input": "500 300 5\n0 50 0 2000\n50 50 0 2000...",
      "expected_fin": 12000
    },
    {
      "name": "Bélády测试1 - 最优替换策略",
      "description": "测试基于未来使用的最优替换算法",
      "input": "300 150 4\n0 100 0 100\n100 100 500 100...",
      "expected_fin": 22400
    }
  ],
...
```bash
cargo run test        # 官方测试（3个）
cargo run test-json   # JSON扩展测试（17个）
```
